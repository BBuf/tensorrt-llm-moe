    ...
    MOEExpertScaleNormalizationMode normalization_mode, cudaStream_t stream)
{
    ...
    printToScreen(gating_output, num_rows * num_experts);
    ...
    printToScreen(softmax_out_, num_rows * num_experts);
    ...
    {
        // printToScreen(permuted_data_, num_rows * k * hidden_size);
        std::cout << "enter here" << std::endl;
        printToScreen(permuted_data_, num_rows * k * hidden_size);
        printToScreen(fc1_expert_weights, inter_size * hidden_size);
        std::cout << "total_tokens_including_expert: " << total_rows_before_expert_ << std::endl;
        std::cout << "expanded_num_rows: " << expanded_active_expert_rows << std::endl;
        std::cout << "fc1_out_size: " << inter_size << std::endl;
